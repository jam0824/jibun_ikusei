...
export class JibunIkuseiStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    api.addRoutes({ path: '/action-log/raw-events/page', methods: [apigwv2.HttpMethod.GET], integration: actionLogIntegration })
    ...
    api.addRoutes({ path: '/action-log/sessions/page', methods: [apigwv2.HttpMethod.GET], integration: actionLogIntegration })
