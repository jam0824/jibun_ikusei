        ...
        <CardContent className="p-5">
          <div className="mb-4 flex items-start justify-between gap-3">
            <div>
              ...
              <div className="mt-1 text-sm text-white/70">次のレベルまであと {levelInfo.nextStepXp}XP</div>
            </div>
          ...
          <div className="mt-4 grid grid-cols-3 gap-2 text-center text-xs">
            ...
            <div className="rounded-2xl bg-white/10 px-2 py-3">
              ...
              <div className="mt-1 text-lg font-semibold">{todayCompletions.length}件</div>
            </div>
            <div className="rounded-2xl bg-white/10 px-2 py-3">
              <div className="text-white/60">音声</div>
              <div className="mt-1 text-lg font-semibold">{settings.lilyAutoPlay === 'off' ? 'OFF' : 'ON'}</div>
            </div>
          </div>
        </CardContent>
      </Card>
