...
export const CHAT_TOOLS = [
  ...
  },
  {
    ...
    function: {
      name: 'complete_quest',
      description: 'クエストをクリア（完了）する。「〇〇をクリアした」「トマトジュース飲んだ」など、タイトルが完全一致でなくても推定してクリアする。漢字・ひらがな・カタカナの表記ゆれや言い換え、近いニュアンスの差も許容する。',
      parameters: {
        type: 'object',
        properties: {
          query: {
            type: 'string',
            description: 'クエストを特定するための検索クエリ。タイトルの一部やキーワードでOK（例:「トマトジュース」「ランニング」）。ユーザー発話そのままでもよく、表記ゆれをならした短い言い換えでもよい。',
          },
          note: {
            type: 'string',
